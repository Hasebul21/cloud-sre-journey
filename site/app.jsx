...
const NAV = [
  ...
  { id: "sre-edge",     label: "03 · API Gateway, LB & HTTP Caching", crumb: "Learn / 03 · API Gateway, Load Balancer & HTTP Caching (Kong / HAProxy)", group: "learn" },
  { id: "sre-revproxy", label: "04 · Reverse Proxy",    crumb: "Learn / 04 · Reverse Proxy (NGINX / Envoy / Caddy)",  group: "learn" },
  { id: "sre-cloud",    label: "05 · Cloud & K8s",      crumb: "Learn / 05 · Cloud & K8s",             group: "learn" },
