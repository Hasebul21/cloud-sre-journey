...
window.SRE_DATA = {
  ...
  sreRoadmap: {
    ...
    varnish: {
      ...
      resources: [
        { id: "vrn-r-1",  type: "video",  name: "Varnish in 100 Seconds (mental model)" },
        { id: "vrn-r-2",  type: "video",  name: "Hussein Nasser — How Varnish HTTP Cache works",                    url: "https://www.youtube.com/results?search_query=hussein+nasser+varnish" },
        { id: "vrn-r-3",  type: "video",  name: "Fastly / Varnish Software — VCL conference talks (search NDC, Velocity)" },
        { id: "vrn-r-4",  type: "course", name: "Varnish 6 Official Documentation — User Guide",                    url: "https://varnish-cache.org/docs/6.0/users-guide/index.html" },
        { id: "vrn-r-5",  type: "course", name: "Varnish 6 — VCL Reference",                                        url: "https://varnish-cache.org/docs/6.0/reference/vcl.html" },
        { id: "vrn-r-6",  type: "course", name: "Varnish 6 — VCL Built-in Subroutines (vcl_recv, vcl_hash, …)",     url: "https://varnish-cache.org/docs/6.0/reference/vcl-step.html" },
        { id: "vrn-r-7",  type: "course", name: "Varnish 6 — VCL Variables (req, bereq, beresp, obj, resp)",        url: "https://varnish-cache.org/docs/6.0/reference/vcl-var.html" },
        { id: "vrn-r-8",  type: "course", name: "Varnish Modules (vmod-cookie, xkey, saintmode, header, var, …)",   url: "https://github.com/varnish/varnish-modules" },
        { id: "vrn-r-9",  type: "course", name: "varnishtest / VTC framework — built-in HTTP test harness",         url: "https://varnish-cache.org/docs/6.0/reference/varnishtest.html" },
        { id: "vrn-r-10", type: "book",   name: "The Varnish Book — Varnish Software (free PDF, definitive guide)", url: "https://info.varnish-software.com/the-varnish-book" },
        { id: "vrn-r-11", type: "book",   name: "Varnish Cache — Per Buer / Linpro (intro book)" },
        { id: "vrn-r-12", type: "blog",   name: "Varnish Software blog — VCL recipes, perf, releases",              url: "https://www.varnish-software.com/community/blog/" },
        { id: "vrn-r-13", type: "blog",   name: "varnish-cache.org — Users' Guide: Grace, Purging, Hit-for-pass",   url: "https://varnish-cache.org/docs/6.0/users-guide/vcl.html" },
        { id: "vrn-r-14", type: "blog",   name: "Fastly VCL docs — same VCL dialect, well-written reference",       url: "https://www.fastly.com/documentation/reference/vcl/" },
        { id: "vrn-r-15", type: "blog",   name: "Hitch — TLS terminator that pairs with Varnish (UDS pattern)",     url: "https://github.com/varnish/hitch" },
      ],
      milestones: [
    ...
    fastly: {
      ...
      resources: [
        { id: "fst-r-1",  type: "course", name: "Fastly VCL Reference (canonical)",                                  url: "https://www.fastly.com/documentation/reference/vcl/" },
        { id: "fst-r-2",  type: "course", name: "Fastly VCL Variables (req / bereq / beresp / obj / resp / client)", url: "https://www.fastly.com/documentation/reference/vcl/variables/" },
        { id: "fst-r-3",  type: "course", name: "Fastly VCL Functions (regsub, subfield, digest.base64_decode, …)",  url: "https://www.fastly.com/documentation/reference/vcl/functions/" },
        { id: "fst-r-4",  type: "course", name: "Fastly Image Optimizer docs",                                       url: "https://www.fastly.com/documentation/reference/io/" },
        { id: "fst-r-5",  type: "course", name: "Fastly Shielding guide",                                            url: "https://www.fastly.com/documentation/guides/full-site-delivery/shielding/" },
        { id: "fst-r-6",  type: "course", name: "Fastly Edge Rate Limiting guide (penaltybox + ratecounter)",        url: "https://www.fastly.com/documentation/guides/full-site-delivery/rate-limiting/" },
        { id: "fst-r-7",  type: "course", name: "Fastly Caching guide (TTL, stale-if-error, Surrogate-Control)",     url: "https://www.fastly.com/documentation/guides/full-site-delivery/caching/" },
        { id: "fst-r-8",  type: "course", name: "Fastly Datacenter / POP codes (lookup table)",                      url: "https://www.fastly.com/documentation/reference/tools/datacenters/" },
        { id: "fst-r-9",  type: "course", name: "Fastly Fiddle — VCL playground (no account required)",              url: "https://fiddle.fastly.dev" },
        { id: "fst-r-10", type: "course", name: "Fastly Developer Hub — Learning + VCL tutorials",                   url: "https://developer.fastly.com/learning/vcl/" },
        { id: "fst-r-11", type: "course", name: "Fastly Terraform Provider (registry, examples)",                    url: "https://registry.terraform.io/providers/fastly/fastly/latest/docs" },
        { id: "fst-r-12", type: "course", name: "Signal Sciences (NGWAF) Terraform Provider",                        url: "https://registry.terraform.io/providers/signalsciences/sigsci/latest/docs" },
        { id: "fst-r-13", type: "course", name: "Fastly CLI (brew install / config / deploy)",                       url: "https://www.fastly.com/documentation/reference/tools/fastly-cli/" },
        { id: "fst-r-14", type: "course", name: "hashicorp/setup-terraform GitHub Action",                           url: "https://github.com/hashicorp/setup-terraform" },
        { id: "fst-r-15", type: "blog",   name: "Fastly Blog — Stronger Security with a Unified CDN and WAF",        url: "https://www.fastly.com/blog/stronger-security-with-a-unified-cdn-and-waf" },
        { id: "fst-r-16", type: "blog",   name: "Fastly Blog — main feed (release notes, perf, VCL recipes)",        url: "https://www.fastly.com/blog" },
        { id: "fst-r-17", type: "blog",   name: "Fastly Documentation — main index",                                 url: "https://www.fastly.com/documentation/" },
        { id: "fst-r-18", type: "blog",   name: "Terraform Workspaces (HashiCorp Learn)",                            url: "https://developer.hashicorp.com/terraform/language/state/workspaces" },
      ],
      milestones: [
